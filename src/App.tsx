...
export default function App() {
  ...
  return <div className="app-shell">
    <div className="announcement"><Sparkles size={14}/> OTPTHAI — ร้านค้าดิจิทัล</div>
    ...
    <main><Routes>
      ...
      <Route path="/account" element={user?<section className="placeholder"><div className="placeholder-icon"><BadgeCheck/></div><h1>บัญชีของฉัน</h1><p>เข้าสู่ระบบแล้ว: {user.email}</p><Link className="button button-primary" to="/admin">หลังบ้านแอดมิน</Link></section>:<AuthPage mode="login"/>}/>
    ...
    <footer><div className="footer-content">
      ...
      <div><strong>สำรวจ</strong><Link to="/products">สินค้าทั้งหมด</Link><Link to="/admin">หลังบ้านแอดมิน</Link></div>
